            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative hidden md:block">
                ...
                <Input
                  ...
                  className="pl-10 pr-4 py-2 w-64 border-gray-200 focus:border-purple-500 focus:ring-purple-500 rounded-full"
                />
              </div>
      ...
      <Dialog open={showProductForm} onOpenChange={setShowProductForm}>
        <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto bg-white/95 backdrop-blur-sm border-0 shadow-2xl">
          ...
          <form onSubmit={handleSaveProduct} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="product-image" className="text-gray-700 font-medium">
                  URL da Imagem
                </Label>
                <Input
                  id="product-image"
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
              ...
              <div className="relative z-10 text-center max-w-6xl mx-auto px-4">
                <div className="mb-8 animate-fade-in-up">
                  ...
                  <p className="text-2xl md:text-3xl mb-4 text-gray-200 font-light">Moda masculina com</p>
              ...
              <section className="py-20 bg-gradient-to-br from-red-50 to-pink-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div className="text-center mb-16">
                    <h3 className="text-5xl font-bold bg-gradient-to-r from-red-600 to-pink-600 bg-clip-text text-transparent mb-4">
                      🔥 Ofertas Imperdíveis
                    </h3>
                ...
                <div className="md:hidden">
                  <div className="relative">
                    ...
                    <Input
                      ...
                      value={searchTerm}
                      onChange={(e) => setSearchTerm(e.target.value)}
                      className="pl-10 pr-4 py-3 w-full border-gray-200 focus:border-purple-500 focus:ring-purple-500 rounded-full"
                    />
                  </div>
                </div>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="bg-gradient-to-br from-white to-gray-50 p-12 rounded-3xl shadow-2xl border border-gray-100">
                <p className="text-xl leading-relaxed text-gray-700 mb-8 text-center max-w-4xl mx-auto">
                  A RV STORE nasceu da paixão por moda e estilo. Trabalhamos com peças selecionadas para homens que
                  querem se destacar com atitude e personalidade. Entregamos para todo o Brasil com segurança e
                  agilidade.
                </p>
